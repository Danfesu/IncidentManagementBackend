...
@SpringBootTest
public class CauseErrorServiceTest {
    
    @Autowired
    CauseErrorService causeErrorService;

     @Test
	public void testFindAllCauseError(){

		List<CauseErrorDTO> expectedResult = new ArrayList<CauseErrorDTO>();
		...
		final List<CauseErrorDTO> result = causeErrorService.findAll();
    ...
    private CauseErrorDTO createItem(Long id, String description){
        CauseErrorDTO causeErrorDTO = new CauseErrorDTO();
        causeErrorDTO.setId(id);
        causeErrorDTO.setDescription(description);
        return causeErrorDTO;
    }
}
